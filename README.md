...
> Automated QA framework for [Adapt the Game](#) built with Playwright + TypeScript.
...
| **Description** | App for access to ADA seating at event venues |
| **Website** | — |
| **LinkedIn** | [View Profile](https://www.adaptthegame.io/) |
| **City** | Tempe |
| **Founded** | 2020 |
| **Funding** | $10 |
| **Employees** | 1-10 |
...
| **Category** | — |
| **Leaders** | Victor OCando (CEO/Founder) |
...
for **Adapt the Game**'s web application.
